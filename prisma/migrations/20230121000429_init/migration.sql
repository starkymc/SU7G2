/*
  ...
  - You are about to alter the column `year` on the `Song` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
